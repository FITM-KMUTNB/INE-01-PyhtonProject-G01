...
shiphit = Actor('laser2',center=(350.5,958))
...
def draw():
    ...
    if gamescreen == 0:
        ...
        bg.draw()
        bg2.draw()
        screen.blit('picss',(120,200))
        screen.blit('pics2',(250,300))
    if gamescreen == 1:
...
def keySPACE():
    ...
    if keyboard.space:
        if lchek == 1 and ammo > 0:
            if itemC == 0: #no item
                sounds.shoot1.play()
                laser.append(Actor('laser2',(ship.x,ship.y-55)))
                ammo -= 1
                #laser[-1].draw() 
            elif itemC == 1: # have item
                laser1.append(Actor('laser2',(ship.x-30,ship.y-20)))
                laser2.append(Actor('laser2',(ship.x+30,ship.y-20)))
                sounds.shoot1.play()
                if ammo == 1:
                    ammo -= 1
                else:
                ...
                laser1.append(Actor('laser2',(ship.x-40,ship.y-20)))
                laser2.append(Actor('laser2',(ship.x+40,ship.y-20)))
                laser3.append(Actor('laser2',(ship.x,ship.y-30)))
                sounds.shoot1.play()
                if ammo == 1:
                    ammo -= 1
                else:
                ...
                #laser2[-1].draw()
            lchek = 0
            clock.schedule(lasercreate,0.4)
...
def randomItem(i): #สุ่มไอเทม#
    ...
    if R >= 1 and R <= 10:
        ...
        buf.append(Actor('item',(i.x,i.y)))
    elif R ==97 or R == 98:
        repair.append(Actor('item',(i.x,i.y)))
...
def spawnalien(): #สุ่มเกิดเอเลื่อน#
    global gamescreen
    if gamescreen == 1:
        R = random.randint(1,4)
        if R == 1:
            alien.append(Actor('1',midbottom=(random.randint(100,650),0)))
        elif R == 2:
            alien1.append(Actor('2',midbottom=(random.randint(100,650),0)))
        elif R == 3:
            alien2.append(Actor('3',midbottom=(random.randint(100,650),0)))
        elif R == 4:
            alien3.append(Actor('3',midbottom=(random.randint(100,650),0)))
...
clock.schedule_interval(spawnalien,0.15)
